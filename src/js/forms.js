...
export const validation = (event) => {
  ...
  const name = event.target.children[0].children[1].children[0].children[1];
  const phone = event.target.children[0].children[1].children[1].children[1];
  const email = event.target.children[0].children[1].children[2].children[1];
  const message = event.target.children[0].children[1].children[3].children[1];
  ...
  if (error) {
    ...
    send(formData, event.target.children[1], event.target.children[2]);
    event.target.reset();
  }
