            ...
            <header>
                ...
                <nav className="disp menu0">
                    ...
                    <div className="heading">
                        ...
                        <a href="mailto:shlooby07@gmail.com" rel="noreferrer" target="_blank" className="fas fa-envelope"><span className="hidden">mail</span></a>
                        <a href="https://www.linkedin.com/in/daniel-costello-579b10259/" rel="noreferrer" target="_blank" className="fab fa-linkedin"><span className="hidden">linkedin</span></a>
